...
export type GetDocumentPaymentsListParams =
...
export type GetDocumentPaymentParams =
  paths['/document-payments/{id}']['get']['parameters']['path'];
export type DeleteDocumentPaymentParams =
  paths['/document-payments/{id}']['delete']['parameters']['path'];
